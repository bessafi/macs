...
@Service
public interface MacsTmpPartService  {	
	...
	ResponseEntity<WorkCentersCahiers> getWorkcentersCahiersFromJsonFile();
	ResponseEntity<List<WorkCenter>> getWorkCentersByProjectSectorSubSector(String projectId, String sectorId,
